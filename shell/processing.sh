...
curl -u "789c46b1-71f6-4ed5-8c54-816aa4f8c502:abczO3xZCLrMN6v2BKK1dXYFpXlPkccOFqm12CdAsMgRU4VrNZ9lyGVCGuMDGIwP" \
 "http://localhost:8081/api/v1/namespaces/_/actions/controllerv001?blocking=true&result=true" \
 -X POST -H "Content-Type: application/json" \
...
#Trigger sequence PRST

curl -u "789c46b1-71f6-4ed5-8c54-816aa4f8c502:abczO3xZCLrMN6v2BKK1dXYFpXlPkccOFqm12CdAsMgRU4VrNZ9lyGVCGuMDGIwP" \
 "http://localhost:8081/api/v1/namespaces/_/actions/prst?blocking=false" \
  -X POST -H "Content-Type: application/json" \
